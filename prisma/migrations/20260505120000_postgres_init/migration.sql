...
-- CreateEnum
CREATE TYPE "ListingStatus" AS ENUM ('DRAFT', 'ACTIVE', 'ENDED_UNSOLD', 'SOLD', 'CANCELLED');

-- CreateEnum
CREATE TYPE "SalesMethod" AS ENUM ('AUCTION_ONLY', 'BUY_NOW_ONLY', 'BOTH');

-- CreateEnum
CREATE TYPE "OrderType" AS ENUM ('AUCTION_WIN', 'BUY_NOW');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING_PAYMENT', 'PAID', 'COMPLETED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "PaymentRecordStatus" AS ENUM ('PENDING', 'COMPLETED', 'FAILED', 'CANCELLED');
...
CREATE TABLE "User" (
    ...
    "sellerRatingAvg" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "buyerRatingAvg" DOUBLE PRECISION NOT NULL DEFAULT 0,
...
CREATE TABLE "Listing" (
    ...
    "salesMethod" "SalesMethod" NOT NULL,
